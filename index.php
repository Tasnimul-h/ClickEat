...
<html lang="en">
	<head>
	    ...
	    <title>Click Eat Home Page</title>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="assets/images/Mouth.png">
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/slider111.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/slider112.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
